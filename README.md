...
# 2. 
Оформленные баг репорты: https://github.com/gggittt/WarUniverse-QA/blob/main/bug-reports.md
...
2. Не ясно на что идёт скидка. Если это внутриигровые покупки, то скидка только на 1 покупку? 
